...
const EXPERIENCE = [
  ...
  },
  {
    ...
    project:
      "SafaiMitra – Waste management solution with GPS tracking and payments",
    location: "Noida, UP",
  ...
  },
  {
    ...
    role: "Software Developer",
    project:
      "SurakshaMitra – SaaS platform for UP Police patrol digitization & monitoring",
    location: "Noida, UP",
    period: "Jun 2023 — Present",
    bullets: [
...
const ACHIEVEMENTS = [
  {
    title: "700+ problems solved on LeetCode",
    detail: "Strong DSA practice and consistent problem-solving streak.",
  },
  {
    title: "158th of 9,000+ – CodeChef November Long (Div 4)",
    detail: "Ranked by solving complex algorithmic challenges.",
  },
  {
    title: "3223rd of 17,000+ – LeetCode Biweekly 103",
    detail: "Solved 3 of 4 problems within time constraints.",
  },
];
        ...
        >
          <motion.div variants={fadeUp(0)}>
            ...
            <h1 className="text-3xl md:text-5xl font-extrabold leading-tight">
              Hi, I’m {CONTACT.name.split(" ")[0]} — I build fast, scalable APIs
              & apps.
            </h1>
          ...
          <motion.div variants={fadeUp(0.15)} className="relative">
            ...
            <div className="relative mx-auto h-56 w-56 md:h-72 md:w-72 rounded-full overflow-hidden ring-4 ring-indigo-500/40 shadow-xl float-slow">
              <img
                src={profilePhoto}
                alt="Ritesh"
                className="h-full w-full object-cover bg-black scale-125 translate-y-3 -translate-x-3"
              />
              {/* gradient glare */}
            ...
            <div className="text-center mt-4">
              ...
              <div className="mt-2 flex flex-wrap justify-center gap-2">
                {["Node.js", "Express", "MongoDB", "Redis", "React", "JWT"].map(
                  (t) => (
                    ...
                    <CardContent className="pt-6">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        {[
                          {
                            k: "APIs",
                            v: job.company.includes("Execution")
                              ? "45+"
                              : "30+",
                          },
                          { k: "Perf Gain", v: "35%" },
                          {
                            k: "Concurrency",
                            v: job.company.includes("Dvertex") ? "10x" : "—",
                          },
                          { k: "Security", v: "JWT" },
                        ].map((m) => (
                          <div
                            key={m.k}
                            className="rounded-xl border border-neutral-200 dark:border-neutral-800 p-3 text-center bg-background"
                          >
    ...
    <section id="contact" className="scroll-mt-24 py-12 md:py-16">
      <div className="mx-auto max-w-6xl px-4">
        ...
        <motion.div
          ...
          whileInView="show"
          viewport={{ once: true, amount: 0.2 }}
          className="rounded-3xl border p-6 md:p-10 bg-gradient-to-br from-neutral-100/70 via-background to-neutral-100/70 dark:from-neutral-900/50 dark:to-neutral-900/50"
        >
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="mt-2 text-muted-foreground">
                I’m available for full-time roles and freelance backend/Full
                Stack work. Reach out and I’ll get back within 24 hours.
              </p>
              ...
              >
                <div className="grid gap-1">
                  ...
                  <input
                    id="name"
                    name="name"
                    className="rounded-xl border border-neutral-300 dark:border-neutral-700 px-3 py-2 bg-background"
                    required
                  />
                </div>
                <div className="grid gap-1">
